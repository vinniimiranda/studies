...
A classe MinHeap implementada em TypeScript (com comparador parametrizável) e sua aplicação Top-K estão no arquivo de Stacks/Queues, agrupadas com Priority Queue por afinidade de uso.

### Min-Heap e aplicações (no arquivo de Stacks/Queues)
