...
A implementação a seguir contém os sete algoritmos discutidos — Bubble, Selection, Insertion, Merge, Quick (com pivô aleatório), Heap e Counting Sort — cada um com função particionada em helpers nomeados (siftDown, indexOfMinFrom, mergeSortedArrays, partitionAroundRandomPivot, etc.) para facilitar a leitura e a comparação.

### Sorting — sete algoritmos, do bubble ao counting
