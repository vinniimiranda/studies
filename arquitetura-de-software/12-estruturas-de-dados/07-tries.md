...
A classe Trie em TypeScript (insert/search/startsWith em O(m), com m = tamanho da palavra) está implementada junto com BST e Traversals no arquivo de árvores, por afinidade conceitual.

### Trie (no arquivo de árvores)
