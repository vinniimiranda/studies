...
A implementação a seguir cobre busca linear, busca binária clássica, lower/upper bound, contagem de ocorrências, primeira ocorrência, busca em rotated sorted array, encontrar pico, raiz quadrada inteira (binary search by answer) e o problema clássico 'Ship Within Days' — exemplo canônico de busca binária sobre a resposta.
